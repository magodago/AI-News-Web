document.addEventListener("DOMContentLoaded", () => {
  ...
  // 15. Dashboard Interactivo (utilizando Chart.js)
  ...
  const dashboardChart = new Chart(dashboardChartCtx, {
    type: 'bar',
    data: {
      labels: ['Inversión', 'Patentes', 'Startups', 'Crecimiento'],
      datasets: [{
        label: 'Indicadores',
        data: [90, 50, 120, 15],
        backgroundColor: ['#0f0', '#0f0', '#0f0', '#0f0']
      }]
    },
    options: {
      responsive: true,
  ...
  // 15. Dashboard Interactivo (Chart.js)
  const dashboardChartCtx = document.getElementById("dashboardChart").getContext("2d");
  const dashboardChart = new Chart(dashboardChartCtx, {
    type: 'bar',
    data: {
  ...
  // 17. (Ya están incluidas las secciones de Crack the Code, Memory AI Cards y Sopa de Letras)

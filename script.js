document.addEventListener("DOMContentLoaded", () => {
  ...
  /* ---------------------------
     8. Quiz de Curiosidades (20 preguntas, Verdadero/Mentira, 2 min)
  --------------------------- */
  const quizQuestions = [
  ...
  /* ---------------------------
     21. Efecto Bola Resplandeciente (Robot Volador)
  --------------------------- */
  ...
  /* ---------------------------
     22. Efecto de Scroll Animado (Fade In)
  --------------------------- */
